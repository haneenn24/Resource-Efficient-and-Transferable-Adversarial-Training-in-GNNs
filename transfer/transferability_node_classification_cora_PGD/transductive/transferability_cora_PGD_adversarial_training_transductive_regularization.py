...
# PGD Adversarial Attack with tqdm progress bar
...
# Adversarial training with tqdm for progress tracking
...
# Step 1: Adversarially train GCN, GAT, and GPRGNN with progress bars
