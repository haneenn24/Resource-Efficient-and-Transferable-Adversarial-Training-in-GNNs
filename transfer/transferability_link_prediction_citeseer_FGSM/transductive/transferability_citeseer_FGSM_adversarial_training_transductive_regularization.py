...
# Load the Citeseer Dataset from PyTorch Geometric
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.bn1 = BatchNorm1d(16)  # Add BatchNorm after first conv layer
...
class GAT(torch.nn.Module):
    def __init__(self):
        ...
        self.bn1 = BatchNorm1d(8 * 8)  # Add BatchNorm after first conv layer
...
class GPRGNN(torch.nn.Module):
    def __init__(self, k_hops=10, alpha=0.1):
        ...
        self.conv1 = GCNConv(dataset.num_node_features, 16)
        self.bn1 = BatchNorm1d(16)  # Add BatchNorm for GPRGNN
        self.conv2 = GCNConv(16, dataset.num_classes)
        self.k_hops = k_hops
        self.alpha = alpha
...
def adversarial_train_model(model, data, epochs=100, epsilon=0.01):
...
results = (
    f"Model Transferability Results after Adversarial Training:\n"
    f"-----------------------------------------\n"
